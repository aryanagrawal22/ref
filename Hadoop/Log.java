...
GenericOptionsParser(c,args).getRemainingArgs();
                ...
                Job j=new Job(c,"Assn1");
                j.setJarByClass(Assn1.class);
...
con) throws IOException, InterruptedException{
                	...
                	Text outputKey = new Text(arr[0]);
                	int login = Integer.parseInt(arr[1]);
                	int logout = Integer.parseInt(arr[2]);
                	int total = logout - login;
                	IntWritable outputVal = new IntWritable(total);
